...
public class FragmentBetweenLeft extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragmentbetweenleft_handset,container,false);
	}
	...
	private OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.left_btn01:
				...
				mFragmentTransaction1.replace(R.id.leftfrag, mRightFragment1);
			...
			case R.id.left_btn02:
				...
				mFragmentTransaction2.replace(R.id.leftfrag, mRightFragment2);
			...
			case R.id.left_btn03:
				...
				mFragmentTransaction3.replace(R.id.leftfrag, mRightFragment3);
