 ...
 *
 */
public class Vertical02_BitmapCache {
	static private Vertical02_BitmapCache cache;
	/** 用于Chche内容的存储 */
	...
	private Vertical02_BitmapCache() {
	 ...
	 * 取得缓存器实例
	 */
	public static Vertical02_BitmapCache getInstance() {
		if (cache == null) {
			cache = new Vertical02_BitmapCache();
		}
		return cache;
